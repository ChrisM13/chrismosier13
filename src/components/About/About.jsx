...
const About = () => {
    return (
        <div className="about">
            <div>
                <img className="picture" src="https://i.imgur.com/9cgCDsr.jpg" alt="profile" />
            </div>
            <div>
                <h2>Summary</h2>
                <div className="container">
                    <p>
                        I’m a Web Developer working in Javascript, React.js, Node.js, Express, MongoDB, jQuery, CSS, HTML, Ruby on Rails, and Github.
                    </p>
                    <p>
                    ...
                    <p>
                        Currently, I’m working on building a full stack web app with MongoDB, Express, React.js, Node.js, JSX, HTML, and CSS.
                    </p>
                </div>
            </div>
            {/* large dev icons */}
